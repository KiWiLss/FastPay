        ...
        setContentView(R.layout.activity_main);
         ...
         findViewById(R.id.btn_test).setOnClickListener(new View.OnClickListener() {
             ...
             public void onClick(View view) {
                 ...
                 Toast.makeText(JavaDemoActivity.this,"hellokitty",Toast.LENGTH_LONG).show();
                 /* 微信 */
                 ...
                 new FastWxPay("wx7e16cf49c52635e2", JavaDemoActivity.this).pay(request, new JavaWxPayObserver() {
                     @Override
